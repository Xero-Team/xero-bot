...
mod tests {
    ...
    fn blank_config() -> Config {
        Config {
            ...
            bors_enabled: false,
            bors_staging_branch: String::new(),
            bors_max_batch: 0,
            bors_ci_timeout_secs: 0,
            bors_poll_interval_secs: 0,
            bors_advance_method: String::new(),
            bors_advance_merge_method: String::new(),
            bors_cleanup_staging: false,
            bors_advance_strict: false,
            label_needs_rebase: String::new(),
            label_waiting_review: String::new(),
            label_waiting_author: String::new(),
            label_blocked: String::new(),
            label_bors_queued: String::new(),
            label_bors_testing: String::new(),
